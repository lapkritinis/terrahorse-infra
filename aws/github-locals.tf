locals {
  ...
  github_environment_secrets = {
    "aws-dev" = {
      SALEOR_COMMERCE_APP_TOKEN = "REPLACE_WITH_DEV_SALEOR_COMMERCE_APP_TOKEN"
      COMMERCE_EVENT_HMAC_KEY   = "REPLACE_WITH_DEV_COMMERCE_EVENT_HMAC_KEY"
      MONTONIO_ACCESS_KEY       = "REPLACE_WITH_DEV_MONTONIO_ACCESS_KEY"
      MONTONIO_SECRET_KEY       = "REPLACE_WITH_DEV_MONTONIO_SECRET_KEY"
      CLOUDFLARED_TUNNEL_TOKEN  = "REPLACE_WITH_DEV_CLOUDFLARED_TUNNEL_TOKEN"
      POSTGRES_PASSWORD         = "REPLACE_WITH_DEV_POSTGRES_PASSWORD"
      SECRET_KEY                = "REPLACE_WITH_DEV_SALEOR_SECRET_KEY"
    }
    "aws-prod" = {
      SALEOR_COMMERCE_APP_TOKEN = "REPLACE_WITH_PROD_SALEOR_COMMERCE_APP_TOKEN"
      COMMERCE_EVENT_HMAC_KEY   = "REPLACE_WITH_PROD_COMMERCE_EVENT_HMAC_KEY"
      MONTONIO_ACCESS_KEY       = "REPLACE_WITH_PROD_MONTONIO_ACCESS_KEY"
      MONTONIO_SECRET_KEY       = "REPLACE_WITH_PROD_MONTONIO_SECRET_KEY"
      CLOUDFLARED_TUNNEL_TOKEN  = "REPLACE_WITH_PROD_CLOUDFLARED_TUNNEL_TOKEN"
      POSTGRES_PASSWORD         = "REPLACE_WITH_PROD_POSTGRES_PASSWORD"
      SECRET_KEY                = "REPLACE_WITH_PROD_SALEOR_SECRET_KEY"
    }
  }
